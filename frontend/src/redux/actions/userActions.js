...
import { 
  ...
  USER_UPDATE_REQUEST,
  USER_UPDATE_SUCCESS,
  USER_UPDATE_FAIL } from '../types/userTypes';
...
export const deteleUser= (id) => async (dispatch, getState) => {
  try{
    dispatch({
...
export const updateUser= (user) => async (dispatch, getState) => {
  try{
    ...
    dispatch({
      type: USER_DETAILS_SUCCESS,  //updating user and sending it to database
      payload: data
    })
    dispatch({ type: USER_DETAILS_RESET })
  }
